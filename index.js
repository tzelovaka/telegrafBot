...
`Добро пожаловать в <b>Сторинтер</b>! Данная система разработана для создания и чтения интерактивных историй (в них сюжет зависит от <i>выбора/выборов</i> читателя в процессе чтения). Если вы хотите попробовать прочитать историю: 
◤◢◣◤◢◣◤◢◣◤◢◣◤◢◣◤◢◣◤◢◣◤
<i>/start -> "Популярное"</i>
◤◢◣◤◢◣◤◢◣◤◢◣◤◢◣◤◢◣◤◢◣◤
если создать:
◤◢◣◤◢◣◤◢◣◤◢◣◤◢◣◤◢◣◤◢◣◤
<i><b>"Редактор"</b> (большая голубая кнопка слева): для создания <b>именно сюжета</b> выйдите из главного меню путём нажатия красной кнопки справа сверху.</i>
◤◢◣◤◢◣◤◢◣◤◢◣◤◢◣◤◢◣◤◢◣◤
Удачи!`
)
